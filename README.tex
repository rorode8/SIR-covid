...
\begin{par}
\begin{flushleft}
\href{https://github.com/rorode8/SIR-covid}{repositorio de github}
\end{flushleft}
\end{par}
...
\begin{par}
\begin{flushleft}
Para simular el comportamiento de la epidemia usaremos el modelo \textbf{SIR }(\textbf{S}usceptible \textbf{I}nfectious \textbf{R}emoved)[1]. El modelo consiste de tres compartimiendos
\end{flushleft}
\end{par}
...
\mlcell{ } & \mlcell{1} & \mlcell{2} & \mlcell{3} & \mlcell{4} & \mlcell{5} \\ \hline
\mlcell{1} & \mlcell{'areaCode'} & \mlcell{'areaName'} & \mlcell{'areaType'} & \mlcell{'date'} & \mlcell{'cumDailyNsoDeathsByDeathDate'} \\ \hline
\mlcell{2} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/25/2021'} & \mlcell{153926} \\ \hline
\mlcell{3} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/24/2021'} & \mlcell{153916} \\ \hline
\mlcell{4} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/23/2021'} & \mlcell{153897} \\ \hline
\mlcell{5} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/22/2021'} & \mlcell{153891} \\ \hline
\mlcell{6} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/21/2021'} & \mlcell{153876} \\ \hline
\mlcell{7} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/20/2021'} & \mlcell{153864} \\ \hline
\mlcell{8} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/19/2021'} & \mlcell{153848} \\ \hline
\mlcell{9} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/18/2021'} & \mlcell{153831} \\ \hline
\mlcell{10} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/17/2021'} & \mlcell{153815} \\ \hline
\mlcell{11} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/16/2021'} & \mlcell{153807} \\ \hline
\mlcell{12} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/15/2021'} & \mlcell{153796} \\ \hline
\mlcell{13} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/14/2021'} & \mlcell{153776} \\ \hline
\mlcell{14} & \mlcell{'K02000001'} & \mlcell{'United Kingdom'} & \mlcell{'overview'} & \mlcell{'6/13/2021'} & \mlcell{153765} \\ 
\hline
\end{tabular}
}
